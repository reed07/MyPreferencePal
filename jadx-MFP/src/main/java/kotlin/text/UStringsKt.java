...
public final class UStringsKt {
    ...
    public static final String m373toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m375toStringolVBNx4(short s, int i) {
    ...
    public static final String m374toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m372toStringJSWoG40(long j, int i) {
    ...
    public static final short toUShort(@NotNull String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m262unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final int toUInt(@NotNull String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m130unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final long toULong(@NotNull String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m197unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i) {
        ...
        int r1 = uIntOrNull.m130unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m89constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m18boximpl(UByte.m24constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int r1 = uIntOrNull.m130unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m89constructorimpl(BusyStates.ALL)) > 0) {
            return null;
        }
        return UShort.m217boximpl(UShort.m223constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        int r4 = UInt.m89constructorimpl(i);
        int r2 = UnsignedKt.m281uintDivideJ1ME1BU(-1, r4);
        while (i3 < length) {
            int digitOf = CharsKt.digitOf(str.charAt(i3), i);
            if (digitOf < 0 || UnsignedKt.uintCompare(i2, r2) > 0) {
                return null;
            }
            int r3 = UInt.m89constructorimpl(i2 * r4);
            int r5 = UInt.m89constructorimpl(UInt.m89constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long r5 = ((long) UInt.m89constructorimpl(i)) & 4294967295L;
        long r2 = UnsignedKt.m283ulongDivideeb3DHEI(-1, ULong.m156constructorimpl(r5));
        long j = 0;
        while (i2 < length) {
            ...
            long r9 = ULong.m156constructorimpl(j * ULong.m156constructorimpl(r5));
            long r11 = ULong.m156constructorimpl(ULong.m156constructorimpl(((long) UInt.m89constructorimpl(digitOf)) & 4294967295L) + r9);
