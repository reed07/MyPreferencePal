...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(long j) {
        long j2 = (long) Statements.GetOwnedFoodIdsDateDescending;
        if (((long) -128) <= j && j2 >= j) {
    ...
    public static final Byte toByteExactOrNull(short s) {
        short s2 = (short) Statements.GetOwnedFoodIdsDateDescending;
        if (((short) -128) <= s && s2 >= s) {
    ...
    public static final Byte toByteExactOrNull(double d) {
        double d2 = (double) Statements.GetOwnedFoodIdsDateDescending;
    ...
    public static final Byte toByteExactOrNull(float f) {
        float f2 = (float) Statements.GetOwnedFoodIdsDateDescending;
        if (f < ((float) -128) || f > f2) {
            return null;
        }
