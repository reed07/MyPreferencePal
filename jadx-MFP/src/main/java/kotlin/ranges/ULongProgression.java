...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m356fromClosedRange7ftBX0g(long j, long j2, long j3) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m343getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int r1 = ((int) ULong.m156constructorimpl(j ^ ULong.m156constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int r12 = (r1 + ((int) ULong.m156constructorimpl(j2 ^ ULong.m156constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m191toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m191toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
