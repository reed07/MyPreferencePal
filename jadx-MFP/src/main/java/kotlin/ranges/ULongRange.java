...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m357containsVKZWuLQ(((ULong) comparable).m197unboximpl());
    }

    @NotNull
    public ULong getStart() {
        return ULong.m150boximpl(getFirst());
    }

    @NotNull
    public ULong getEndInclusive() {
        return ULong.m150boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ reason: not valid java name */
    public boolean m357containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m156constructorimpl(getLast() ^ ULong.m156constructorimpl(getLast() >>> 32))) + (((int) ULong.m156constructorimpl(getFirst() ^ ULong.m156constructorimpl(getFirst() >>> 32))) * 31);
    }

    @NotNull
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(ULong.m191toStringimpl(getFirst()));
        sb.append("..");
        sb.append(ULong.m191toStringimpl(getLast()));
        return sb.toString();
    }
