...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m355containsWZ4Q5Ns(((UInt) comparable).m130unboximpl());
    }

    @NotNull
    public UInt getStart() {
        return UInt.m83boximpl(getFirst());
    }

    @NotNull
    public UInt getEndInclusive() {
        return UInt.m83boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns reason: not valid java name */
    public boolean m355containsWZ4Q5Ns(int i) {
    ...
    public String toString() {
        ...
        sb.append(UInt.m124toStringimpl(getFirst()));
        sb.append("..");
        sb.append(UInt.m124toStringimpl(getLast()));
        return sb.toString();
    }
}
