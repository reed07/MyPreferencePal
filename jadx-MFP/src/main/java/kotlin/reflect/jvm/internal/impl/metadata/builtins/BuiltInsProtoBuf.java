...
public final class BuiltInsProtoBuf {
    ...
    public static final GeneratedExtension<Property, Value> compileTimeValue = GeneratedMessageLite.newSingularGeneratedExtension(Property.getDefaultInstance(), Value.getDefaultInstance(), Value.getDefaultInstance(), null, PacketTypes.EmailUniquenessCheckRequest, FieldType.MESSAGE, Value.class);
    ...
    public static final GeneratedExtension<Package, Integer> packageFqName = GeneratedMessageLite.newSingularGeneratedExtension(Package.getDefaultInstance(), Integer.valueOf(0), null, null, PacketTypes.EmailUniquenessCheckRequest, FieldType.INT32, Integer.class);
