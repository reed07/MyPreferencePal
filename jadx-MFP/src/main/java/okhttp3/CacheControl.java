    ...
    public static CacheControl parse(Headers headers) {
        ...
        while (i2 < size) {
            ...
            while (i7 < value.length()) {
                int skipUntil = okhttp3.internal.http.HttpHeaders.skipUntil(value, i7, "=,;");
                ...
                if (skipUntil == value.length() || value.charAt(skipUntil) == ',' || value.charAt(skipUntil) == ';') {
                    ...
                    if (skipWhitespace >= value.length() || value.charAt(skipWhitespace) != '\"') {
                        i = okhttp3.internal.http.HttpHeaders.skipUntil(value, skipWhitespace, ",;");
                ...
                if ("no-cache".equalsIgnoreCase(trim)) {
                    ...
                    i3 = okhttp3.internal.http.HttpHeaders.parseSeconds(str, -1);
                    ...
                    i5 = okhttp3.internal.http.HttpHeaders.parseSeconds(str, Integer.MAX_VALUE);
                } else if ("min-fresh".equalsIgnoreCase(trim)) {
                    i6 = okhttp3.internal.http.HttpHeaders.parseSeconds(str, -1);
