    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (VERSION.SDK_INT > 21) {
                ...
                SERVICES.put(CameraManager.class, PermissionAnalyticsHelper.CAMERA);
            ...
            if (VERSION.SDK_INT > 19) {
                ...
                SERVICES.put(CaptioningManager.class, VideoFields.CAPTIONING);
            ...
            SERVICES.put(ActivityManager.class, AbstractEvent.ACTIVITY);
            ...
            SERVICES.put(DownloadManager.class, Attributes.XPROMO_DOWNLOAD);
            ...
            SERVICES.put(StorageManager.class, PermissionAnalyticsHelper.STORAGE);
