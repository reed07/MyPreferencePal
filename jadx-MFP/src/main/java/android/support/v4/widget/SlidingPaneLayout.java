...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends Callback {
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                if (f < BitmapDescriptorFactory.HUE_RED || (f == BitmapDescriptorFactory.HUE_RED && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
            ...
            while (i18 < childCount) {
                ...
                if (childAt2.getVisibility() == i5) {
                    ...
                    if (childAt2.getVisibility() == i5) {
                        ...
                        } else if (layoutParams2.width >= 0 || (i7 <= i17 && layoutParams2.weight <= BitmapDescriptorFactory.HUE_RED)) {
                            i6 = i17;
                        } else {
                            if (!z5) {
                                i9 = 1073741824;
        ...
        if (this.mFirstLayout) {
            if (this.mCanSlide) {
                ...
                for (int i17 = 0; i17 < childCount; i17++) {
                    dimChildView(getChildAt(i17), BitmapDescriptorFactory.HUE_RED, this.mSliderFadeColor);
                }
            }
    ...
    public boolean isDimmed(View view) {
        ...
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (this.mCanSlide && layoutParams.dimWhenOffset && this.mSlideOffset > BitmapDescriptorFactory.HUE_RED) {
            z = true;
        }
        return z;
    }
