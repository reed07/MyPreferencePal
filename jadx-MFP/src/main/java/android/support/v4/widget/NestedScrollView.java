...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        obtain.offsetLocation(BitmapDescriptorFactory.HUE_RED, (float) this.mNestedYOffset);
        switch (actionMasked) {
            case 0:
                if (getChildCount() != 0) {
            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (dispatchNestedPreScroll(0, i2, this.mScrollConsumed, this.mScrollOffset, 0)) {
                        ...
                        obtain.offsetLocation(BitmapDescriptorFactory.HUE_RED, (float) this.mScrollOffset[1]);
