            ...
            if (i != 0) {
                ...
                if (i2 != 1) {
                    switch (i2) {
                        case 3:
                        case 6:
                            boolean z8 = z2 ? !fragment.mAdded && fragment.mView != null && fragment.mView.getVisibility() == 0 && fragment.mPostponedAlpha >= BitmapDescriptorFactory.HUE_RED : fragment.mAdded && !fragment.mHidden;
                            z3 = z8;
                            z5 = false;
                            z4 = true;
                            break;
