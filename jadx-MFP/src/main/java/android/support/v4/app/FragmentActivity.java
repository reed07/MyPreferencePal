...
public class FragmentActivity extends SupportActivity implements ViewModelStoreOwner, OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    public void onActivityResult(int i, int i2, @Nullable Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onActivityResult(i & BusyStates.ALL, i2, intent);
            }
            return;
        }
    ...
    public void onRequestPermissionsResult(int i, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (i2 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onRequestPermissionsResult(i & BusyStates.ALL, strArr, iArr);
            }
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, @Nullable Bundle bundle) {
        ...
        if (i == -1) {
            ...
            checkForValidRequestCode(i);
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (i & BusyStates.ALL), bundle);
            this.mStartedActivityFromFragment = false;
        }
    }
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int i, @Nullable Intent intent, int i2, int i3, int i4, Bundle bundle) throws SendIntentException {
        ...
        if (i5 == -1) {
            ...
            checkForValidRequestCode(i);
            ActivityCompat.startIntentSenderForResult(this, intentSender, ((allocateRequestIndex(fragment) + 1) << 16) + (i5 & BusyStates.ALL), intent, i2, i3, i4, bundle);
            this.mStartedIntentSenderFromFragment = false;
        }
    }
    ...
    public void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        ...
        try {
            ...
            ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + 1) << 16) + (i & BusyStates.ALL));
        } finally {
