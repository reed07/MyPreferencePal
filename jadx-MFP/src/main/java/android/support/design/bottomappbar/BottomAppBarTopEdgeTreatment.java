...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float f, float f2, ShapePath shapePath) {
        ...
        if (f4 == BitmapDescriptorFactory.HUE_RED) {
            shapePath2.lineTo(f3, BitmapDescriptorFactory.HUE_RED);
            return;
        }
        ...
        float f14 = f11 - f6;
        shapePath2.lineTo(f14, BitmapDescriptorFactory.HUE_RED);
        float f15 = f6 * 2.0f;
        float f16 = degrees;
        shapePath.addArc(f14, BitmapDescriptorFactory.HUE_RED, f11 + f6, f15, 270.0f, degrees);
        shapePath.addArc(f7 - f5, (-f5) - f8, f7 + f5, f5 - f8, 180.0f - f13, (f13 * 2.0f) - 180.0f);
        shapePath.addArc(f12 - f6, BitmapDescriptorFactory.HUE_RED, f12 + f6, f15, 270.0f - f16, f16);
        shapePath2.lineTo(f3, BitmapDescriptorFactory.HUE_RED);
    }
