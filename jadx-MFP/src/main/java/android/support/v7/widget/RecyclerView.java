...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!ViewCompat.hasAccessibilityDelegate(view)) {
                    viewHolder.addFlags(C.DASH_ROLE_CAPTION_FLAG);
        ...
        public void addViewHolderToRecycledViewPool(@NonNull ViewHolder viewHolder, boolean z) {
            ...
            if (viewHolder.hasAnyOfTheFlags(C.DASH_ROLE_CAPTION_FLAG)) {
                viewHolder.setFlags(0, C.DASH_ROLE_CAPTION_FLAG);
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutFrozen && motionEvent.getAction() == 8) {
            if ((motionEvent.getSource() & 2) != 0) {
                f2 = this.mLayout.canScrollVertically() ? -motionEvent.getAxisValue(9) : BitmapDescriptorFactory.HUE_RED;
                f = this.mLayout.canScrollHorizontally() ? motionEvent.getAxisValue(10) : BitmapDescriptorFactory.HUE_RED;
