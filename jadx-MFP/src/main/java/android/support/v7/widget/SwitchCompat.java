...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        TextPaint textPaint = this.mTextPaint;
        StaticLayout staticLayout = new StaticLayout(charSequence2, textPaint, charSequence2 != null ? (int) Math.ceil((double) Layout.getDesiredWidth(charSequence2, textPaint)) : 0, Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, true);
        return staticLayout;
    }
