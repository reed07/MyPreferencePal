...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    final ValueAnimator mShowHideAnimator = ValueAnimator.ofFloat(new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f});
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (((Float) FastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == BitmapDescriptorFactory.HUE_RED) {
