...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        this.mBarLength = (float) Math.round(obtainStyledAttributes.getDimension(R.styleable.DrawerArrowToggle_barLength, BitmapDescriptorFactory.HUE_RED));
        this.mArrowHeadLength = (float) Math.round(obtainStyledAttributes.getDimension(R.styleable.DrawerArrowToggle_arrowHeadLength, BitmapDescriptorFactory.HUE_RED));
        this.mArrowShaftLength = obtainStyledAttributes.getDimension(R.styleable.DrawerArrowToggle_arrowShaftLength, BitmapDescriptorFactory.HUE_RED);
    ...
    public void draw(Canvas canvas) {
        ...
        float round = (float) Math.round(lerp(BitmapDescriptorFactory.HUE_RED, this.mMaxCutForBarSize, this.mProgress));
        float lerp3 = lerp(BitmapDescriptorFactory.HUE_RED, ARROW_HEAD_ANGLE, this.mProgress);
        double d = (double) lerp;
        float lerp4 = lerp(z ? BitmapDescriptorFactory.HUE_RED : -180.0f, z ? 180.0f : BitmapDescriptorFactory.HUE_RED, this.mProgress);
        ...
        float f2 = (-lerp2) / 2.0f;
        this.mPath.moveTo(f2 + round, BitmapDescriptorFactory.HUE_RED);
        this.mPath.rLineTo(lerp2 - (round * 2.0f), BitmapDescriptorFactory.HUE_RED);
