...
public class Analyzer {
    ...
    private static boolean traverse(ConstraintWidget constraintWidget, ConstraintWidgetGroup constraintWidgetGroup, List<ConstraintWidgetGroup> list, boolean z) {
        ...
        if (constraintWidget.mBelongingGroup == null) {
            ...
            if (((constraintWidget.getHorizontalDimensionBehaviour() == DimensionBehaviour.MATCH_CONSTRAINT) ^ (constraintWidget.getVerticalDimensionBehaviour() == DimensionBehaviour.MATCH_CONSTRAINT)) && constraintWidget.mDimensionRatio != BitmapDescriptorFactory.HUE_RED) {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        if (constraintWidget.getDimensionBehaviour(i) == DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget2.mDimensionRatio != BitmapDescriptorFactory.HUE_RED) {
            constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i14);
        }
    ...
    private static void updateSizeDependentWidgets(ConstraintWidget constraintWidget, int i, int i2) {
        ...
        } else if (constraintWidget.mDimensionRatio == BitmapDescriptorFactory.HUE_RED || constraintWidget.getDimensionBehaviour(i) != DimensionBehaviour.MATCH_CONSTRAINT) {
