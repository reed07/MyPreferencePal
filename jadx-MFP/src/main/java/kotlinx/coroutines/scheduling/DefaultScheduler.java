...
public final class DefaultScheduler extends ExperimentalCoroutineDispatcher {
    ...
    static {
        ...
        IO = defaultScheduler.blocking(SystemPropsKt.systemProp$default("kotlinx.coroutines.io.parallelism", RangesKt.coerceAtLeast(64, SystemPropsKt.getAVAILABLE_PROCESSORS()), 0, 0, 12, (Object) null));
    }
