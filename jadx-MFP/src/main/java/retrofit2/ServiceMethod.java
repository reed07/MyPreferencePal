    ...
    static final class Builder<T, R> {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                parseHttpMethodAndPath(HttpConstants.METHOD_DELETE, ((DELETE) annotation).value(), false);
            } else if (annotation instanceof GET) {
                parseHttpMethodAndPath(HttpConstants.METHOD_GET, ((GET) annotation).value(), false);
                ...
                parseHttpMethodAndPath(HttpConstants.METHOD_POST, ((POST) annotation).value(), true);
            } else if (annotation instanceof PUT) {
                parseHttpMethodAndPath(HttpConstants.METHOD_PUT, ((PUT) annotation).value(), true);
            ...
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        ...
                        sb8.append(value5);
                        sb8.append("\"");
                        Headers of = Headers.of(HttpHeaders.CONTENT_DISPOSITION, sb8.toString(), "Content-Transfer-Encoding", part.encoding());
