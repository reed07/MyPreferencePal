                ...
                for (Entry entry : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            sb.append(str);
                            sb.append("\"");
                            requestBuilder.addPart(Headers.of(HttpHeaders.CONTENT_DISPOSITION, sb.toString(), "Content-Transfer-Encoding", this.transferEncoding), (RequestBody) this.valueConverter.convert(value));
                        } else {
                            StringBuilder sb2 = new StringBuilder();
