...
class Headers {
    ...
    public static final Header METHOD_GET_HEADER = new Header(Header.TARGET_METHOD, HttpConstants.METHOD_GET);
    public static final Header METHOD_HEADER = new Header(Header.TARGET_METHOD, HttpConstants.METHOD_POST);
    public static final Header SCHEME_HEADER = new Header(Header.TARGET_SCHEME, Constants.HTTPS);
