...
class SqlCipherPreparedStatement extends BasePreparedStatement {
    ...
    SqlCipherPreparedStatement(SqlCipherConnection sqlCipherConnection, String str, int i) throws SQLException {
        super(sqlCipherConnection, str, i);
        this.connection = sqlCipherConnection;
        this.statement = sqlCipherConnection.getDatabase().compileStatement(str);
    }
    ...
    public int executeUpdate() throws SQLException {
        if (this.autoGeneratedKeys == 1) {
            ...
            try {
                ...
                SqlCipherConnection.throwSQLException(e2);
            }
        }
