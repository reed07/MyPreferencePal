...
public final class ApplicationModule_ProvidesRadialGraphNutrientDashboardFactory implements Factory<RadialGraphNutrientDashboard> {
    ...
    public static RadialGraphNutrientDashboard provideInstance(ApplicationModule applicationModule, Provider<Context> provider, Provider<UserEnergyService> provider2, Provider<Session> provider3, Provider<LocalizedStringsUtil> provider4, Provider<StepService> provider5, Provider<ActionTrackingService> provider6, Provider<NutrientGoalService> provider7, Provider<NutrientGoalsUtil> provider8, Provider<PremiumService> provider9, Provider<SharedPreferences> provider10, Provider<DiaryService> provider11, Provider<AppGalleryService> provider12, Provider<GoogleFitClient> provider13, Provider<NutrientDashboardAnalyticsHelper> provider14) {
        return proxyProvidesRadialGraphNutrientDashboard(applicationModule, (Context) provider.get(), DoubleCheck.lazy(provider2), DoubleCheck.lazy(provider3), DoubleCheck.lazy(provider4), DoubleCheck.lazy(provider5), DoubleCheck.lazy(provider6), DoubleCheck.lazy(provider7), DoubleCheck.lazy(provider8), DoubleCheck.lazy(provider9), DoubleCheck.lazy(provider10), DoubleCheck.lazy(provider11), DoubleCheck.lazy(provider12), DoubleCheck.lazy(provider13), DoubleCheck.lazy(provider14));
    }

    public static ApplicationModule_ProvidesRadialGraphNutrientDashboardFactory create(ApplicationModule applicationModule, Provider<Context> provider, Provider<UserEnergyService> provider2, Provider<Session> provider3, Provider<LocalizedStringsUtil> provider4, Provider<StepService> provider5, Provider<ActionTrackingService> provider6, Provider<NutrientGoalService> provider7, Provider<NutrientGoalsUtil> provider8, Provider<PremiumService> provider9, Provider<SharedPreferences> provider10, Provider<DiaryService> provider11, Provider<AppGalleryService> provider12, Provider<GoogleFitClient> provider13, Provider<NutrientDashboardAnalyticsHelper> provider14) {
        ApplicationModule_ProvidesRadialGraphNutrientDashboardFactory applicationModule_ProvidesRadialGraphNutrientDashboardFactory = new ApplicationModule_ProvidesRadialGraphNutrientDashboardFactory(applicationModule, provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14);
        return applicationModule_ProvidesRadialGraphNutrientDashboardFactory;
    }

    public static RadialGraphNutrientDashboard proxyProvidesRadialGraphNutrientDashboard(ApplicationModule applicationModule, Context context, Lazy<UserEnergyService> lazy, Lazy<Session> lazy2, Lazy<LocalizedStringsUtil> lazy3, Lazy<StepService> lazy4, Lazy<ActionTrackingService> lazy5, Lazy<NutrientGoalService> lazy6, Lazy<NutrientGoalsUtil> lazy7, Lazy<PremiumService> lazy8, Lazy<SharedPreferences> lazy9, Lazy<DiaryService> lazy10, Lazy<AppGalleryService> lazy11, Lazy<GoogleFitClient> lazy12, Lazy<NutrientDashboardAnalyticsHelper> lazy13) {
        return (RadialGraphNutrientDashboard) Preconditions.checkNotNull(applicationModule.providesRadialGraphNutrientDashboard(context, lazy, lazy2, lazy3, lazy4, lazy5, lazy6, lazy7, lazy8, lazy9, lazy10, lazy11, lazy12, lazy13), "Cannot return null from a non-@Nullable @Provides method");
    }
}
