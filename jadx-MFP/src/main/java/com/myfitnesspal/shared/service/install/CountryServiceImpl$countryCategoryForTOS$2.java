...
final class CountryServiceImpl$countryCategoryForTOS$2 extends Lambda implements Function0<MapOfStringString> {
    final /* synthetic */ CountryServiceImpl this$0;

    CountryServiceImpl$countryCategoryForTOS$2(CountryServiceImpl countryServiceImpl) {
        this.this$0 = countryServiceImpl;
        super(0);
    }

    public final MapOfStringString invoke() {
        return (MapOfStringString) new ApiJsonMapper().tryMapFrom(FileUtils.readAllLinesFromAsset(this.this$0.context, "tos/countries.json"), MapOfStringString.class);
    }
}
