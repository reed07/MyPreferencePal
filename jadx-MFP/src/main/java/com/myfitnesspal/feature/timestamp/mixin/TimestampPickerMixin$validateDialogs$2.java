...
final class TimestampPickerMixin$validateDialogs$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TimestampPickerMixin this$0;

    TimestampPickerMixin$validateDialogs$2(TimestampPickerMixin timestampPickerMixin) {
