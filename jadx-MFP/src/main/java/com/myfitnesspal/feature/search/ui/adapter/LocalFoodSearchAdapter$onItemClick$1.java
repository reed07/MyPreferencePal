...
final class LocalFoodSearchAdapter$onItemClick$1 extends Lambda implements Function2<DiaryEntryCellModel, Integer, Unit> {
    public static final LocalFoodSearchAdapter$onItemClick$1 INSTANCE = new LocalFoodSearchAdapter$onItemClick$1();

    LocalFoodSearchAdapter$onItemClick$1() {
        super(2);
    }
