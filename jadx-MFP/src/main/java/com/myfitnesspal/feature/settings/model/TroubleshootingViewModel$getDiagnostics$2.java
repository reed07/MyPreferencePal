...
final class TroubleshootingViewModel$getDiagnostics$2<T> implements Consumer<String> {
    final /* synthetic */ ObjectRef $uri;
    final /* synthetic */ TroubleshootingViewModel this$0;

    TroubleshootingViewModel$getDiagnostics$2(TroubleshootingViewModel troubleshootingViewModel, ObjectRef objectRef) {
