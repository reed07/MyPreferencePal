...
final class FoodFeedbackActivity$nameNotEmpty$1 extends Lambda implements Function1<EditText, Boolean> {
    public static final FoodFeedbackActivity$nameNotEmpty$1 INSTANCE = new FoodFeedbackActivity$nameNotEmpty$1();

    FoodFeedbackActivity$nameNotEmpty$1() {
        super(1);
    }
