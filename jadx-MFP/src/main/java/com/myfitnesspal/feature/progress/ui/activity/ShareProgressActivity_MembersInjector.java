...
public final class ShareProgressActivity_MembersInjector implements MembersInjector<ShareProgressActivity> {
    ...
    public static MembersInjector<ShareProgressActivity> create(Provider<AdsSettings> provider, Provider<InputMethodManager> provider2, Provider<StartupManager> provider3, Provider<RecipeService> provider4, Provider<ActionTrackingService> provider5, Provider<BackgroundJobHelper> provider6, Provider<PremiumService> provider7, Provider<SyncService> provider8, Provider<StepService> provider9, Provider<UacfScheduler<SyncType>> provider10, Provider<UacfScheduler<AnalyticsSyncMode>> provider11, Provider<AppIndexerBot> provider12, Provider<LocalSettingsService> provider13, Provider<AdsAnalyticsHelper> provider14, Provider<MfpAnalyticsService> provider15, Provider<GoogleFitClient> provider16, Provider<SHealthConnection> provider17, Provider<DeepLinkManager> provider18, Provider<ConfigService> provider19, Provider<AdUnitService> provider20, Provider<ApiUrlProvider> provider21, Provider<Glide> provider22, Provider<GlobalSettingsService> provider23, Provider<RecipesAnalyticsHelper> provider24, Provider<DbConnectionManager> provider25, Provider<AdvancedDebuggingUtil> provider26, Provider<PermissionAnalyticsHelper> provider27, Provider<LocationService> provider28, Provider<ProgressAnalytics> provider29, Provider<ProgressService> provider30) {
        ShareProgressActivity_MembersInjector shareProgressActivity_MembersInjector = new ShareProgressActivity_MembersInjector(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16, provider17, provider18, provider19, provider20, provider21, provider22, provider23, provider24, provider25, provider26, provider27, provider28, provider29, provider30);
        return shareProgressActivity_MembersInjector;
    }
    ...
    public void injectMembers(ShareProgressActivity shareProgressActivity) {
        ...
        MfpActivity_MembersInjector.injectStartupManager(shareProgressActivity, (StartupManager) this.startupManagerProvider.get());
        ...
        MfpActivity_MembersInjector.injectAdsAnalyticsHelper(shareProgressActivity, DoubleCheck.lazy(this.adsAnalyticsHelperProvider));
        ...
        MfpActivity_MembersInjector.injectGlide(shareProgressActivity, (Glide) this.glideProvider.get());
        ...
        MfpActivity_MembersInjector.injectDbConnectionManager(shareProgressActivity, (DbConnectionManager) this.dbConnectionManagerProvider.get());
        ...
        MfpActivity_MembersInjector.injectLocationService(shareProgressActivity, DoubleCheck.lazy(this.locationServiceProvider));
        ...
        injectConfigService(shareProgressActivity, DoubleCheck.lazy(this.configServiceProvider));
    }

    public static void injectProgressAnalytics(ShareProgressActivity shareProgressActivity, Lazy<ProgressAnalytics> lazy) {
    ...
    public static void injectConfigService(ShareProgressActivity shareProgressActivity, Lazy<ConfigService> lazy) {
        shareProgressActivity.configService = lazy;
    }
}
