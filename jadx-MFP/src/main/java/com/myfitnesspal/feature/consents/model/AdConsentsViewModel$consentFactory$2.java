...
final class AdConsentsViewModel$consentFactory$2 extends Lambda implements Function0<UacfConsentServiceSdkFactory> {
    public static final AdConsentsViewModel$consentFactory$2 INSTANCE = new AdConsentsViewModel$consentFactory$2();

    AdConsentsViewModel$consentFactory$2() {
        super(0);
    }
