...
final class ConsentsViewModel$updatedConsentsFlow$1 implements Action {
    final /* synthetic */ ConsentsViewModel this$0;

    ConsentsViewModel$updatedConsentsFlow$1(ConsentsViewModel consentsViewModel) {
    ...
    public final void run() {
        ...
        this.this$0.updateConsentsStatus.setValue(new Success(Boolean.valueOf(true)));
    }
}
