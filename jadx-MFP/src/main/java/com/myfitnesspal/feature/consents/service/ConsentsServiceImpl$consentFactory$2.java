...
final class ConsentsServiceImpl$consentFactory$2 extends Lambda implements Function0<UacfConsentServiceSdkFactory> {
    public static final ConsentsServiceImpl$consentFactory$2 INSTANCE = new ConsentsServiceImpl$consentFactory$2();

    ConsentsServiceImpl$consentFactory$2() {
        super(0);
    }
