...
final class ConsentsServiceImpl$getConsentStatus$1<V> implements Callable<T> {
    final /* synthetic */ String $iso;
    final /* synthetic */ ConsentsServiceImpl this$0;

    ConsentsServiceImpl$getConsentStatus$1(ConsentsServiceImpl consentsServiceImpl, String str) {
    ...
    public final UacfConsentStatus call() {
        return this.this$0.getConsentServiceSdk().getConsentStatus(new UacfConsentIsoCodeProvider(this) {
            final /* synthetic */ ConsentsServiceImpl$getConsentStatus$1 this$0;
