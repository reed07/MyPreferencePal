...
final class ConsentsActivity$validateAcceptance$2<T> implements Observer<Resource<? extends Boolean>> {
    final /* synthetic */ ConsentsActivity this$0;

    ConsentsActivity$validateAcceptance$2(ConsentsActivity consentsActivity) {
        this.this$0 = consentsActivity;
    }

    public final void onChanged(@Nullable Resource<Boolean> resource) {
        if (resource instanceof Success) {
            if (this.this$0.getViewModel().isExistingAddMode()) {
                ((ConsentsAnalyticsHelper) this.this$0.getConsentsAnalyticsHelper().get()).reportConsentInterruptionAccepted();
            }
