...
final class ConsentsViewModel$finishSignUpFlow$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ConsentsViewModel this$0;

    ConsentsViewModel$finishSignUpFlow$2(ConsentsViewModel consentsViewModel) {
        this.this$0 = consentsViewModel;
    }

    public final void accept(Throwable th) {
        SingleLiveEvent access$getSignUpStatus$p = this.this$0.signUpStatus;
        Intrinsics.checkExpressionValueIsNotNull(th, "it");
        access$getSignUpStatus$p.setValue(new Error(th));
