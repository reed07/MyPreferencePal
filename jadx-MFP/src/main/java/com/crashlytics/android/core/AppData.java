...
class AppData {
    ...
    public static AppData create(Context context, IdManager idManager, String str, String str2) throws NameNotFoundException {
        ...
        AppData appData = new AppData(str, str2, installerPackageName2, packageName2, Integer.toString(packageInfo.versionCode), packageInfo.versionName == null ? "0.0" : packageInfo.versionName);
        return appData;
    }
