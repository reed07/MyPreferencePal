...
class BinaryImagesConverter {
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            Fabric.getLogger().w("CrashlyticsCore", "Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
    ...
    private JSONObject jsonFromMapEntryString(String str) {
        ...
        try {
            try {
                ...
                Fabric.getLogger().d("CrashlyticsCore", "Could not create a binary image json string", e);
                return null;
            }
            ...
            Fabric.getLogger().d("CrashlyticsCore", sb.toString(), e2);
            return null;
        }
    }
    ...
    private File correctDataPath(File file) {
        ...
        if (file.getAbsolutePath().startsWith("/data")) {
            try {
                ...
                Fabric.getLogger().e("CrashlyticsCore", "Error getting ApplicationInfo", e);
            }
        }
        return file;
    }
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            Fabric.getLogger().w("CrashlyticsCore", "Binary images string is null", e);
            return new byte[0];
        }
    }
    ...
    private static JSONObject createBinaryImageJson(String str, ProcMapEntry procMapEntry) throws JSONException {
        ...
        jSONObject.put(AbstractEvent.SIZE, procMapEntry.size);
