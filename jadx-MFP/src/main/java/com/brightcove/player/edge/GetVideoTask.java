...
@ListensFor(events = {})
@Emits(events = {})
public class GetVideoTask extends EdgeTask implements Component {
    private long startResponseTimeMs;
    private VideoListener videoListener;

    @Deprecated
    public GetVideoTask(@NonNull EventEmitter eventEmitter, @NonNull String str, @Nullable Map<String, String> map, @NonNull String str2, @NonNull String str3) {
        this(eventEmitter, str, new Builder().addRequestHeaders(map).build(), str2, str3);
    }

    @Deprecated
    public GetVideoTask(@NonNull EventEmitter eventEmitter, @NonNull String str, @Nullable Map<String, String> map, @Nullable Map<String, String> map2, @NonNull String str2, @NonNull String str3) {
        this(eventEmitter, str, new Builder().addRequestHeaders(map).addQueryParameters(map2).build(), str2, str3);
    }

    public GetVideoTask(@NonNull EventEmitter eventEmitter, @NonNull String str, @NonNull HttpRequestConfig httpRequestConfig, @NonNull String str2, @NonNull String str3) {
        super(eventEmitter, str, httpRequestConfig, str2, str3);
    }

    public void getById(String str, VideoListener videoListener2) {
        this.videoListener = videoListener2;
        try {
            URI createURI = createURI("accounts", this.account, BlogCategory.VIDEOS, str);
    ...
    public void getByReferenceId(String str, VideoListener videoListener2) {
        this.videoListener = videoListener2;
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("ref:");
            sb.append(str);
            URI createURI = createURI("accounts", this.account, BlogCategory.VIDEOS, sb.toString());
            execute(new URI[]{createURI});
            emitAnalyticsCatalogRequest(createURI);
        } catch (URISyntaxException e) {
            e.printStackTrace();
    ...
    public void onPostExecute(JSONObject jSONObject) {
            ...
            try {
                if (!jSONObject.isNull(NativeProtocol.BRIDGE_ARG_ERROR_CODE)) {
                    ...
                    if (!jSONObject.isNull("message")) {
                        this.videoListener.onError(jSONObject.getString("message"));
                    }
                } else {
                    this.videoListener.onVideo(new BrightcoveTokenAuthorizer().configure(VideoParser.buildVideoFromJSON(jSONObject, this.eventEmitter), this.httpRequestConfig.getBrightcoveAuthorizationToken()));
                }
        ...
        if (!this.errors.isEmpty()) {
            for (String onError : this.errors) {
                this.videoListener.onError(onError);
            }
        }
    }
}
