...
public class RewardedVideoBroadcastReceiver extends BaseBroadcastReceiver {
    ...
    @Nullable
    private RewardedVideoInterstitialListener mRewardedVideoListener;

    public RewardedVideoBroadcastReceiver(@Nullable RewardedVideoInterstitialListener rewardedVideoInterstitialListener, long j) {
        super(j);
