...
public class CloseButtonDrawable extends BaseWidgetDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas2.drawLine(f + BitmapDescriptorFactory.HUE_RED, f2 - f, f3 - f, f + BitmapDescriptorFactory.HUE_RED, this.closeButtonPaint);
        float f4 = this.halfStrokeWidth;
        canvas2.drawLine(f4 + BitmapDescriptorFactory.HUE_RED, f4 + BitmapDescriptorFactory.HUE_RED, f3 - f4, f2 - f4, this.closeButtonPaint);
    }
}
