...
public class DownloadDrawablesAsync extends AsyncTask<Object, Void, HashMap<String, Drawable>> {
    ...
    public HashMap<String, Drawable> doInBackground(Object... objArr) {
        ...
        Future drawableFuture = getDrawableFuture((URL) hashMap.get(KEY_IMAGE), newCachedThreadPool);
        Future drawableFuture2 = getDrawableFuture((URL) hashMap.get(KEY_ICON), newCachedThreadPool);
        try {
            Drawable drawable = (Drawable) drawableFuture.get(10, TimeUnit.SECONDS);
            Drawable drawable2 = (Drawable) drawableFuture2.get(10, TimeUnit.SECONDS);
