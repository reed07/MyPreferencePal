...
public class FixedSizeDrawable extends Drawable {
    ...
    FixedSizeDrawable(State state2, Drawable drawable) {
        ...
        this.wrappedRect = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) drawable.getIntrinsicWidth(), (float) drawable.getIntrinsicHeight());
