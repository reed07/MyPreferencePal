...
public final class AdSize {
    ...
    public static final AdSize IAB_MRECT = new AdSize(LogSeverity.NOTICE_VALUE, Callback.DEFAULT_SWIPE_ANIMATION_DURATION, "as");
    public static final AdSize IAB_WIDE_SKYSCRAPER = new AdSize(160, LogSeverity.CRITICAL_VALUE, "as");
