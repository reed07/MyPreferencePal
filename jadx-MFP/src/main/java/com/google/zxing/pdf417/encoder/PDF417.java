...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        if (errorCorrectionCodewordCount + length + 1 <= 929) {
            ...
            encodeLowLevel(sb3.toString(), i2, i3, i, this.barcodeMatrix);
            return;
        }
        StringBuilder sb4 = new StringBuilder("Encoded message contains too many code words, message too big (");
        sb4.append(str.length());
        sb4.append(" bytes)");
        throw new WriterException(sb4.toString());
    }
    ...
    private int[] determineDimensions(int i, int i2) throws WriterException {
        ...
        for (int i3 = this.minCols; i3 <= this.maxCols; i3++) {
            ...
            if (calculateNumberOfRows <= this.maxRows) {
                float f2 = (((float) ((i3 * 17) + 69)) * DEFAULT_MODULE_WIDTH) / (((float) calculateNumberOfRows) * 2.0f);
