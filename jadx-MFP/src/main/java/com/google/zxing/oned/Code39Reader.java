...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, ResultCodes.ERROR_OTHER, 70, 22, 385, RequestCodes.CONFIRM_PHOTO_IMPORT, 448, RequestCodes.FILE_CHOOSER, LogSeverity.WARNING_VALUE, RequestCodes.PREMIUM_UPSELL, PacketTypes.ThirdPartyAccountVerify, 388, RequestCodes.FOOD_MULTI_ADD_EDITOR, PacketTypes.ThirdPartyDissociateResponse, 168, RequestCodes.MACROS_SUMMARY, 138, 42};
