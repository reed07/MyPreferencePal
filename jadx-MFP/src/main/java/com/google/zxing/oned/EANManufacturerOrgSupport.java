...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{30, 39}, Country.UNITED_STATES_SHORT);
            ...
            add(new int[]{450, 459}, Country.JAPANESE_SHORT);
            add(new int[]{460, 469}, "RU");
            add(new int[]{471}, Country.SIMPLIFIED_CHINESE_SHORT);
            add(new int[]{474}, "EE");
            add(new int[]{475}, "LV");
            add(new int[]{476}, "AZ");
            add(new int[]{477}, "LT");
            ...
            add(new int[]{487}, "KZ");
            add(new int[]{489}, "HK");
            add(new int[]{490, 499}, Country.JAPANESE_SHORT);
            ...
            add(new int[]{690, 695}, Country.TRADITIONAL_CHINESE_SHORT);
            ...
            add(new int[]{746}, "DO");
            add(new int[]{750}, "MX");
            add(new int[]{754, 755}, Country.CANADA_SHORT);
            add(new int[]{759}, "VE");
            ...
            add(new int[]{880}, Country.KOREA_SOUTH_SHORT);
            add(new int[]{885}, "TH");
            add(new int[]{888}, "SG");
            add(new int[]{890}, "IN");
            add(new int[]{893}, "VN");
