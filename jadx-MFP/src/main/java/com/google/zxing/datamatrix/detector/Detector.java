...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            bitMatrix = sampleGrid(this.image, resultPoint, resultPoint12, resultPoint11, resultPoint2, (transitions3 & 1) == 1 ? transitions3 + 1 : transitions3, (transitions4 & 1) == 1 ? transitions4 + 1 : transitions4);
        } else {
            ...
            bitMatrix = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPoint2, i3, i3);
            resultPoint = resultPoint13;
        }
    ...
    private boolean isValid(ResultPoint resultPoint) {
        return resultPoint.getX() >= BitmapDescriptorFactory.HUE_RED && resultPoint.getX() < ((float) this.image.getWidth()) && resultPoint.getY() > BitmapDescriptorFactory.HUE_RED && resultPoint.getY() < ((float) this.image.getHeight());
    }
