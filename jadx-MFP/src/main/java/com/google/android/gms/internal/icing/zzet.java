...
final class zzet {
    static String zza(zzeq zzeq, String str) {
    ...
    private static void zza(zzeq zzeq, StringBuilder sb, int i) {
        Method[] declaredMethods;
        boolean z;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet<>();
        for (Method method : zzeq.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zzw(concat), zzdj.zza(method2, (Object) zzeq, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zzw(concat2), zzdj.zza(method3, (Object) zzeq, new Object[0]));
                }
            }
            String str2 = "set";
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? str2.concat(valueOf5) : new String(str2))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzdj.zza(method4, (Object) zzeq, new Object[0]);
                    if (method5 == null) {
                        boolean z2 = zza instanceof Boolean ? !((Boolean) zza).booleanValue() : zza instanceof Integer ? ((Integer) zza).intValue() == 0 : zza instanceof Float ? ((Float) zza).floatValue() == BitmapDescriptorFactory.HUE_RED : zza instanceof Double ? ((Double) zza).doubleValue() == 0.0d : zza instanceof String ? zza.equals("") : zza instanceof zzce ? zza.equals(zzce.zzfx) : zza instanceof zzeq ? zza == ((zzeq) zza).zzbv() : zza instanceof Enum ? ((Enum) zza).ordinal() == 0 : false;
                        z = !z2;
                    } else {
                        z = ((Boolean) zzdj.zza(method5, (Object) zzeq, new Object[0])).booleanValue();
                    }
                    if (z) {
                        zza(sb, i, zzw(concat3), zza);
                    }
                }
            }
        }
        if (zzeq instanceof zzc) {
            Iterator it = ((zzc) zzeq).zzjz.iterator();
            if (it.hasNext()) {
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzft.zzd(zzce.zzt((String) obj)));
                sb.append(Typography.quote);
            } else if (obj instanceof zzce) {
                sb.append(": \"");
                sb.append(zzft.zzd((zzce) obj));
                sb.append(Typography.quote);
    ...
    private static final String zzw(String str) {
        StringBuilder sb = new StringBuilder();
