...
public final class zzas extends zzn<zzcd> {
    public static final Api<NoOptions> API = new Api<>("Fitness.SENSORS_API", new zzau(), CLIENT_KEY);
    private static final ClientKey<zzas> CLIENT_KEY = new ClientKey<>();
    public static final Api<FitnessOptions> zzew = new Api<>("Fitness.SENSORS_CLIENT", new zzaw(), CLIENT_KEY);

    private zzas(Context context, Looper looper, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
