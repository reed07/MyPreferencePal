...
public class zzay {
    ...
    public static final AtomicBoolean zzci = new AtomicBoolean();
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            java.lang.Class<com.google.android.gms.internal.icing.zzay> r12 = com.google.android.gms.internal.icing.zzay.class
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzcj     // Catch:{ all -> 0x00f5 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = zzci     // Catch:{ all -> 0x00f5 }
            ...
            com.google.android.gms.internal.icing.zzaz r4 = new com.google.android.gms.internal.icing.zzaz     // Catch:{ all -> 0x00f5 }
        ...
        L_0x002a:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = zzck     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = zzcl     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = zzcm     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = zzcn     // Catch:{ all -> 0x00f5 }
            r0.clear()     // Catch:{ all -> 0x00f5 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f5 }
            r0.<init>()     // Catch:{ all -> 0x00f5 }
            zzco = r0     // Catch:{ all -> 0x00f5 }
            zzcp = r2     // Catch:{ all -> 0x00f5 }
        L_0x0054:
            java.lang.Object r0 = zzco     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = zzcj     // Catch:{ all -> 0x00f5 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f5 }
            if (r4 == 0) goto L_0x006c
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzcj     // Catch:{ all -> 0x00f5 }
        ...
        L_0x006a:
            ...
            return r10
        L_0x006c:
            java.lang.String[] r4 = zzcq     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0070:
            ...
            boolean r0 = zzcp     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x0086
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzcj     // Catch:{ all -> 0x00f5 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f5 }
            if (r0 == 0) goto L_0x00a9
        L_0x0086:
            java.lang.String[] r0 = zzcq     // Catch:{ all -> 0x00f5 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = zzcj     // Catch:{ all -> 0x00f5 }
