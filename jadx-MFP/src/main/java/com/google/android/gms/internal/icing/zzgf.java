...
final class zzgf {
    private static final zzgg zzov;
    ...
    public static boolean zzd(byte[] bArr) {
        return zzov.zzc(bArr, 0, bArr.length);
    }
    ...
    static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzov.zzb(charSequence, bArr, i, i2);
    }

    static {
        zzgg zzgg;
        if (!(zzgd.zzdr() && zzgd.zzds()) || zzcb.zzal()) {
            zzgg = new zzgh();
        } else {
            zzgg = new zzgj();
        }
