...
public class AdvertisingIdClient {
    ...
    private final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        hashMap.put("app_context", z ? AppEventsConstants.EVENT_PARAM_VALUE_YES : "0");
        if (info != null) {
            hashMap.put(Events.LIMIT_AD_TRACKING, info.isLimitAdTrackingEnabled() ? AppEventsConstants.EVENT_PARAM_VALUE_YES : "0");
        }
