...
interface zzgr {
    ...
    void zza(int i, zzce zzce) throws IOException;

    <K, V> void zza(int i, zzej<K, V> zzej, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzff zzff) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzff zzff) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzff zzff) throws IOException;

    void zzb(int i, List<zzce> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzff zzff) throws IOException;
