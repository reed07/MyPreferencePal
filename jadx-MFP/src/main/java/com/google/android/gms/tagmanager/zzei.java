...
final class zzei extends zzbq {
    ...
    private static final String zzbek = zzb.MIN.toString();
    private static final String zzbel = zzb.MAX.toString();
