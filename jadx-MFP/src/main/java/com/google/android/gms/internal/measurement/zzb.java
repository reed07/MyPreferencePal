...
public enum zzb {
    ...
    DEFAULT_VALUE(Extras.DEFAULT_VALUE),
    ...
    METRIC("metric"),
    MIN("min"),
    MODE(InternalAvidAdSessionContext.CONTEXT_MODE),
    NAME("name"),
    ...
    ORDINAL("ordinal"),
    ORGANIC(UtmValues.ORGANIC),
    OUTPUT_FORMAT("output_format"),
    PAGE("page"),
    PAGE_PATH("page_path"),
    PARAMS(NativeProtocol.WEB_DIALOG_PARAMS),
    PARTITION("partition"),
    PERCENTAGE(MacroGoalFormat.PERCENTAGE),
    PIXEL("pixel"),
    PLACEMENT("placement"),
    ...
    SOCIAL_NETWORK(AttributeKey.SOCIAL_NETWORK),
