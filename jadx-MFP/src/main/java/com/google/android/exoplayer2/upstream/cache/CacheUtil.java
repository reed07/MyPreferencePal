...
public final class CacheUtil {
    ...
    public static void cache(DataSpec dataSpec, Cache cache, CacheDataSource cacheDataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i, @Nullable CachingCounters cachingCounters, @Nullable AtomicBoolean atomicBoolean, boolean z) throws IOException, InterruptedException {
        ...
        DataSpec dataSpec2 = dataSpec;
        Cache cache2 = cache;
        CachingCounters cachingCounters3 = cachingCounters;
        Assertions.checkNotNull(cacheDataSource);
        Assertions.checkNotNull(bArr);
        if (cachingCounters3 != null) {
            getCached(dataSpec2, cache2, cachingCounters3);
        ...
        while (contentLength != 0) {
            ...
            if (cachedLength > 0) {
                ...
                j = j3;
                if (readAndDiscard(dataSpec, j2, j3, cacheDataSource, bArr, priorityTaskManager, i, cachingCounters2, atomicBoolean) < j) {
                    if (z && i2 != 0) {
