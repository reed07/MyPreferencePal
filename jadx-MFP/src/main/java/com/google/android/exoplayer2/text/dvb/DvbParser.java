    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < iArr.length; i++) {
            if (i < 8) {
                ...
                int i2 = i & 1;
                int i3 = Statements.GetOwnedFoodIdsDateDescending;
                int i4 = i2 != 0 ? Statements.GetOwnedFoodIdsDateDescending : 0;
                int i5 = (i & 2) != 0 ? Statements.GetOwnedFoodIdsDateDescending : 0;
                if ((i & 4) == 0) {
                    i3 = 0;
                }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            if (i < 8) {
                ...
                int i5 = i & 136;
                int i6 = RequestCodes.CHALLENGES;
                int i7 = 85;
                if (i5 == 0) {
                    int i8 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? RequestCodes.CHALLENGES : 0);
                    int i9 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? RequestCodes.CHALLENGES : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {
                    ...
                    int i10 = 43;
                    if (i5 == 128) {
                        int i11 = ((i & 1) != 0 ? 43 : 0) + Statements.GetOwnedFoodIdsDateDescending + ((i & 16) != 0 ? 85 : 0);
                        int i12 = ((i & 2) != 0 ? 43 : 0) + Statements.GetOwnedFoodIdsDateDescending + ((i & 32) != 0 ? 85 : 0);
                        if ((i & 4) == 0) {
                            i10 = 0;
                        }
                        int i13 = i10 + Statements.GetOwnedFoodIdsDateDescending;
                        if ((i & 64) == 0) {
                            i7 = 0;
                        }
                    ...
                    int i16 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? RequestCodes.CHALLENGES : 0);
                    int i17 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? RequestCodes.CHALLENGES : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {
                    ...
                    iArr[i] = getColor(Statements.GetOwnedFoodIdsDateDescending, i16, i17, i7 + i6);
                }
            }
        }
        return iArr;
        ...
        while (parsableBitArray.bitsLeft() != 0) {
            ...
            if (readBits != 240) {
                switch (readBits) {
                    case 16:
                        if (i4 == 3) {
                            bArr2 = bArr4 == null ? defaultMap2To8 : bArr4;
                        } else if (i4 == 2) {
                            bArr2 = bArr5 == null ? defaultMap2To4 : bArr5;
                        } else {
                            bArr2 = null;
                        }
                        int paint2BitPixelCodeString = paint2BitPixelCodeString(parsableBitArray, iArr, bArr2, i5, i6, paint, canvas2);
                        parsableBitArray.byteAlign();
                        i5 = paint2BitPixelCodeString;
                        break;
                    case 17:
                        int paint4BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr, i4 == 3 ? defaultMap4To8 : null, i5, i6, paint, canvas2);
                        parsableBitArray.byteAlign();
                        i5 = paint4BitPixelCodeString;
                        break;
                    case 18:
