...
public final class NalUnitUtil {
    ...
    public static SpsData parseSpsNalUnit(byte[] bArr, int i, int i2) {
        ...
        int readBit2 = parsableNalUnitBitArray.readBit();
        int i12 = (2 - readBit2) * readUnsignedExpGolombCodedInt6;
        if (readBit2 == 0) {
            parsableNalUnitBitArray.skipBit();
        }
        parsableNalUnitBitArray.skipBit();
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            i5 = i13 - ((readUnsignedExpGolombCodedInt7 + readUnsignedExpGolombCodedInt8) * i7);
        } else {
            i5 = i13;
        }
        float f2 = 1.0f;
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            SpsData spsData = new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt, i5, i14, f, z, readBit2, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt3, i4, z2);
            return spsData;
        }
        f = 1.0f;
        SpsData spsData2 = new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt, i5, i14, f, z, readBit2, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt3, i4, z2);
        return spsData2;
    }
