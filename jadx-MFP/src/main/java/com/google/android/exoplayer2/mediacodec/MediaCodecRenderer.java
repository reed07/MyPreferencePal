...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    /* access modifiers changed from: protected */
    public List<MediaCodecInfo> getDecoderInfos(MediaCodecSelector mediaCodecSelector2, Format format2, boolean z) throws DecoderQueryException {
    ...
    public final void maybeInitCodec() throws ExoPlaybackException {
        ...
        if (this.codec == null) {
            ...
            if (format2 != null) {
                ...
                boolean z2 = false;
                if (drmSession2 != null) {
                    FrameworkMediaCrypto frameworkMediaCrypto = (FrameworkMediaCrypto) drmSession2.getMediaCrypto();
    ...
    public final Format updateOutputFormatForTime(long j) {
        Format format2 = (Format) this.formatQueue.pollFloor(j);
        if (format2 != null) {
        ...
        if (!this.availableCodecInfos.isEmpty()) {
            do {
                ...
                try {
                    ...
                    DecoderInitializationException decoderInitializationException = new DecoderInitializationException(this.format, (Throwable) e2, z, mediaCodecInfo.name);
            ...
            if (this.waitingForKeys) {
                ...
                if (this.codecReconfigurationState == 1) {
                    for (int i4 = 0; i4 < this.format.initializationData.size(); i4++) {
                        this.buffer.data.put((byte[]) this.format.initializationData.get(i4));
                    }
            ...
            if (this.codecOperatingRate != codecOperatingRate2) {
                ...
                if (this.codec != null && this.codecReinitializationState == 0) {
                    ...
                    if (i == 0 && this.codecConfiguredWithOperatingRate) {
                        reinitializeCodec();
                    } else if (i != 0 && (this.codecConfiguredWithOperatingRate || codecOperatingRate2 > this.assumedMinimumCodecOperatingRate)) {
