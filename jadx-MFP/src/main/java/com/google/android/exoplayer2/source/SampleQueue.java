...
public class SampleQueue implements TrackOutput {
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleExtrasHolder sampleExtrasHolder) {
        ...
        int[] iArr4 = decoderInputBuffer2.cryptoInfo.numBytesOfEncryptedData;
        ...
        if (z) {
            ...
            iArr[0] = 0;
            iArr2[0] = sampleExtrasHolder2.size - ((int) (j3 - sampleExtrasHolder2.offset));
        }
        CryptoData cryptoData = sampleExtrasHolder2.cryptoData;
        decoderInputBuffer2.cryptoInfo.set(i, iArr, iArr2, cryptoData.encryptionKey, decoderInputBuffer2.cryptoInfo.iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
