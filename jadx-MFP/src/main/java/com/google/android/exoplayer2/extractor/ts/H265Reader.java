...
public final class H265Reader implements ElementaryStreamReader {
    ...
    private static Format parseMediaFormat(String str, NalUnitTargetBuffer nalUnitTargetBuffer, NalUnitTargetBuffer nalUnitTargetBuffer2, NalUnitTargetBuffer nalUnitTargetBuffer3) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            i2 = readUnsignedExpGolombCodedInt2 - (((readUnsignedExpGolombCodedInt == 1 || readUnsignedExpGolombCodedInt == 2) ? 2 : 1) * (parsableNalUnitBitArray.readUnsignedExpGolombCodedInt() + parsableNalUnitBitArray.readUnsignedExpGolombCodedInt()));
            i = readUnsignedExpGolombCodedInt3 - ((readUnsignedExpGolombCodedInt == 1 ? 2 : 1) * (parsableNalUnitBitArray.readUnsignedExpGolombCodedInt() + parsableNalUnitBitArray.readUnsignedExpGolombCodedInt()));
        } else {
        ...
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            return Format.createVideoSampleFormat(str, MimeTypes.VIDEO_H265, null, -1, -1, i2, i, -1.0f, Collections.singletonList(bArr), -1, f, null);
        }
        f = 1.0f;
        return Format.createVideoSampleFormat(str, MimeTypes.VIDEO_H265, null, -1, -1, i2, i, -1.0f, Collections.singletonList(bArr), -1, f, null);
    }
