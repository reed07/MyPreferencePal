...
final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, long j, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, MediaPeriodInfo mediaPeriodInfo) {
        ...
        MediaPeriod createPeriod = mediaSource2.createPeriod(mediaPeriodInfo.id, allocator, mediaPeriodInfo.startPositionUs);
        if (mediaPeriodInfo.id.endPositionUs != Long.MIN_VALUE) {
            ClippingMediaPeriod clippingMediaPeriod2 = new ClippingMediaPeriod(createPeriod, true, 0, mediaPeriodInfo.id.endPositionUs);
