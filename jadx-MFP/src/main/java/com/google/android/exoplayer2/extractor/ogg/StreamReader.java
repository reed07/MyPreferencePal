...
abstract class StreamReader {
    ...
    private int readHeaders(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.setupData.oggSeeker != null) {
            ...
            DefaultOggSeeker defaultOggSeeker = new DefaultOggSeeker(this.payloadStartPosition, extractorInput.getLength(), this, (long) (pageHeader.headerSize + pageHeader.bodySize), pageHeader.granulePosition, (pageHeader.type & 4) != 0);
