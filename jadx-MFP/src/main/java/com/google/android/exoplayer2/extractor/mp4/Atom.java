...
abstract class Atom {
    ...
    public static final int TYPE_mean = Util.getIntegerCodeForString(BloodPressure.MEAN);
    ...
    public static final int TYPE_uuid = Util.getIntegerCodeForString(AbstractEvent.UUID);
