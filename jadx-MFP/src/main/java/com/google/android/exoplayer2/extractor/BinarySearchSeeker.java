...
public abstract class BinarySearchSeeker {
    ...
    public static final class TimestampSearchResult {
        ...
        static {
            TimestampSearchResult timestampSearchResult = new TimestampSearchResult(-3, -9223372036854775807L, -1);
        ...
        public static TimestampSearchResult targetFoundResult(long j) {
            TimestampSearchResult timestampSearchResult = new TimestampSearchResult(0, -9223372036854775807L, j);
            return timestampSearchResult;
        }
    }
