...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, (long) i2, (byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    i >>>= 7;
                }
            ...
            while ((i & -128) != 0) {
                ...
                this.position = i4 + 1;
                bArr3[i4] = (byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128);
                this.totalBytesWritten++;
                i >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    j >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128);
                this.totalBytesWritten++;
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i4, (byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i5 = this.position;
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            while ((i & -128) != 0) {
                this.buffer.put((byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128));
                i >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.buffer.put((byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128));
                j >>>= 7;
            }
            try {
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    i >>>= 7;
                }
            ...
            while (true) {
                ...
                if (j3 >= this.limit) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((i & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j & -128) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    j >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.limit) {
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((((int) j) & Statements.GetOwnedFoodIdsDateDescending) | 128));
                    j >>>= 7;
                }
            }
        }
