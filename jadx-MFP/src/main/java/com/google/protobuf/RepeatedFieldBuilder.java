...
public class RepeatedFieldBuilder<MType extends GeneratedMessage, BType extends Builder, IType extends MessageOrBuilder> implements BuilderParent {
    ...
    private MType getMessage(int i, boolean z) {
        ...
        SingleFieldBuilder singleFieldBuilder = (SingleFieldBuilder) list.get(i);
    ...
    public RepeatedFieldBuilder<MType, BType, IType> setMessage(int i, MType mtype) {
        if (mtype != null) {
            ...
            List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
            if (list != null) {
                SingleFieldBuilder singleFieldBuilder = (SingleFieldBuilder) list.set(i, null);
                if (singleFieldBuilder != null) {
    ...
    public void remove(int i) {
        ...
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
        if (list != null) {
            SingleFieldBuilder singleFieldBuilder = (SingleFieldBuilder) list.remove(i);
            if (singleFieldBuilder != null) {
                singleFieldBuilder.dispose();
            }
        }
    ...
    public void clear() {
        ...
        List<SingleFieldBuilder<MType, BType, IType>> list = this.builders;
        if (list != null) {
            for (SingleFieldBuilder singleFieldBuilder : list) {
                if (singleFieldBuilder != null) {
                    singleFieldBuilder.dispose();
                }
            }
