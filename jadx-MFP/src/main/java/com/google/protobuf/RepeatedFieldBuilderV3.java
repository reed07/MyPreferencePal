...
public class RepeatedFieldBuilderV3<MType extends AbstractMessage, BType extends Builder, IType extends MessageOrBuilder> implements BuilderParent {
    ...
    public RepeatedFieldBuilderV3<MType, BType, IType> setMessage(int i, MType mtype) {
        ...
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
        if (list != null) {
            SingleFieldBuilderV3 singleFieldBuilderV3 = (SingleFieldBuilderV3) list.set(i, null);
            if (singleFieldBuilderV3 != null) {
    ...
    public void remove(int i) {
        ...
        List<SingleFieldBuilderV3<MType, BType, IType>> list = this.builders;
        if (list != null) {
            SingleFieldBuilderV3 singleFieldBuilderV3 = (SingleFieldBuilderV3) list.remove(i);
            if (singleFieldBuilderV3 != null) {
                singleFieldBuilderV3.dispose();
            }
        }
