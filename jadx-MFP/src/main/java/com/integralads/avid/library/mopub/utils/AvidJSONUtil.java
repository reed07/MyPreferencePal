...
public class AvidJSONUtil {
    private static String[] KEYS = {KEY_X, "y", "width", "height"};
    ...
    public static boolean equalStates(@NonNull JSONObject jSONObject, @Nullable JSONObject jSONObject2) {
        ...
        if (compareRequiredValues(jSONObject, jSONObject2) && compareSessionId(jSONObject, jSONObject2) && compareFriendlySessionIds(jSONObject, jSONObject2) && compareChildren(jSONObject, jSONObject2)) {
            z = true;
        }
        return z;
    }
