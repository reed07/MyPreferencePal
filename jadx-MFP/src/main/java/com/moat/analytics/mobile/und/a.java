...
class a {
    ...
    /* renamed from: com.moat.analytics.mobile.und.a$a reason: collision with other inner class name */
    private static class C0051a implements ActivityLifecycleCallbacks {
        C0051a() {
        }
    ...
    static void a(Application application) {
        ...
        if (!b) {
            b = true;
            c.registerActivityLifecycleCallbacks(new C0051a());
        }
    }
