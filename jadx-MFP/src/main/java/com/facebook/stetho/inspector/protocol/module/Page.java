...
public class Page implements ChromeDevtoolsDomain {
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree(AppEventsConstants.EVENT_PARAM_VALUE_YES, null, "Stetho", it.hasNext() ? (String) it.next() : "");
        ...
        while (it.hasNext()) {
            ...
            sb3.append("Child #");
            sb3.append(sb2);
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(sb2, str2, sb3.toString(), str));
            i = i2;
        }
