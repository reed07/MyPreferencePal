...
public class AdSettings {
    ...
    public static TestAdType getTestAdType() {
        ...
        AdInternalSettings.a.putSerializable("TEST_AD_TYPE_KEY", TestAdType.DEFAULT);
    ...
    public static void setIntegrationErrorMode(IntegrationErrorMode integrationErrorMode) {
        AdInternalSettings.a.putSerializable("SRL_INTEGRATION_ERROR_MODE_KEY", integrationErrorMode);
    }

    public static void setIsChildDirected(boolean z) {
        AdInternalSettings.a.putBoolean("BOOL_CHILD_DIRECTED_KEY", z);
    }
    ...
    public static void setTestAdType(TestAdType testAdType) {
        AdInternalSettings.a.putSerializable("TEST_AD_TYPE_KEY", testAdType);
    }
